...
export interface Quiz {
  ...
  quotes?: Quote[];
  topic: string;
  type?: 'multiple-choice' | '5-clues' | 'detective' | 'find-in-map' | 'jumbled-letters' | 'match-the-following' | 'combat-mode' | 'word-search' | 'mega-quiz' | 'identify-image' | 'text-presentation' | 'rapid-fire' | 'blurred-image' | 'a-to-z';
}
