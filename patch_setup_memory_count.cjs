...
// Replace in quiz generation/building payload
code = code.replace(
  "data.themeMemoryBreak = themeMemoryBreak;",
  "data.themeMemoryBreak = themeMemoryBreak;\n      data.memoryBreakImageCount = memoryBreakImageCount;"
);

// Replace in handleFileSelect and finalQuiz constructions
code = code.replace(
  /themeMemoryBreak, enableInsightImages/g,
  "themeMemoryBreak, memoryBreakImageCount, enableInsightImages"
);

// We need to add the UI in Setup.tsx.
